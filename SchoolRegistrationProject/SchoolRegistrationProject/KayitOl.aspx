<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="SchoolRegistrationProject.KayitOl" %>
...
<%--                        <input type="email" class="form-control" placeholder="loremipsum@email.com" name="Email"
                            required="">--%>
                        <asp:TextBox ID="TextBox2" CssClass="form-control" placeholder="yourmail@email.com" runat="server"></asp:TextBox>

                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Password</label>
                        <%--<input type="password" class="form-control" placeholder="*****" name="Password" required="">--%>
                        <asp:TextBox ID="TextBox3" CssClass="form-control" placeholder="*****" TextMode="Password" runat="server"></asp:TextBox>

                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Confirm Password</label>
<%--                        <input type="password" class="form-control" placeholder="*****" name="Password" required="">--%>
                        <asp:TextBox ID="TextBox4" CssClass="form-control" placeholder="*****" TextMode="Password" runat="server"></asp:TextBox>
                    ...
                    <asp:Button ID="Button1" Class="btn button-style-w3" runat="server" Text="Register" OnClick="Button1_Click" />
                </form>
            </div>
            <!-- //register -->
        </div>
